                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Id Room</th><th>Sub Name</th><th>Professor</th><th>Day</th><th>Time Start</th><th>Time End</th><th>Esc</th><th>User Id</th><th>Phone</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($book as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->id_room }}</td><td>{{ $item->sub_name }}</td><td>{{ $item->professor }}</td><td>{{ $item->day }}</td><td>{{ $item->time_start }}</td><td>{{ $item->time_end }}</td><td>{{ $item->esc }}</td><td>{{ $item->user_id }}</td><td>{{ $item->phone }}</td>
                                        <td>
